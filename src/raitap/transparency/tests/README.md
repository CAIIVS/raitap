...
If `src/raitap/transparency/tests/mpl_baseline/captum_ig_image_heat_map.png` is missing, stop and ask the user to generate or provide it. The approved baseline should then be committed into `mpl_baseline/`.
