...
`--hydra-help`) are not listed here, see {ref}`hydra-flags`.

## General CLI flags

| CLI                               | Python API           | Env var | Description                                                                                                        |
| --------------------------------- | -------------------- | ------- | ------------------------------------------------------------------------------------------------------------------ |
| `--demo`{#flag-demo}              | —                    | —       | Run the bundled `demo` config. Equivalent to `--config-name demo` against the packaged `raitap.configs` directory. |
